            ...
            <header className={"fixed top-0 w-full  z-30 bg-white-500 transition-all " + (scrollActive ? "shadow-md pt-0" : " pt-4")}>
                <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
                    ...
                    <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500 items-center">
                        ...
                        <Link to="/create-job" className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-black-500 hover:text-orange-500">
                            Post a Job
                        </Link>
                        <Link to="/list-jobs" className="px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative text-black-500 hover:text-orange-500">
                            Find a Job
                        </Link>
                    </ul>
