    ...
    const onSubmit = async (data) => {
        ...
        if (isRegister) {
            if (accountType === "seeker") {
                ...
                URL = "jobmanager/register";
            }
        } else {
            if (accountType === "seeker") {
                URL = "auth/login";
            } else {
                URL = "jobmanager/login";
            }
        }
                                ...
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all ">
                                    ...
                                    <div className="w-full flex items-center justify-center py-4 ">
                                        <button
                                            className={`flex-1 px-4 py-2 rounded text-sm outline-none ${
                                                accountType === "seeker" ? "bg-[#1d4fd862] text-blue-900 font-semibold" : "bg-white border border-blue-400"
                                            }`}
                                    ...
                                    <div className="mt-4">
                                        <p className="text-sm text-gray-700">
                                            ...
                                            <span className="text-sm text-blue-600 ml-2 hover:text-blue-700 hover:font-semibold cursor-pointer" onClick={() => setIsRegister((prev) => !prev)}>
